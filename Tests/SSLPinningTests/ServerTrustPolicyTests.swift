...
struct ServerTrustPolicyTests {
    ...
    func testEquatable_pinning() {
        let p1 = Pin(host: "a.com", serialNumber: "1", sha256: "x", sha1: "y")
        let p2 = Pin(host: "a.com", serialNumber: "1", sha256: "x", sha1: "y")
        let p3 = Pin(host: "b.com", serialNumber: "2", sha256: "x2", sha1: "y2")
    ...
    func testCodable_pinning_roundTrip() throws {
        let pins = [
            Pin(host: "a.com", serialNumber: "1", sha256: "s256", sha1: "s1"),
            Pin(host: "b.com", serialNumber: "2", sha256: "s256b", sha1: "s1b")
        ]
    ...
    func testJSON_contract_pinning() throws {
        let policy: ServerTrustPolicy = .pinning([
            Pin(host: "a.com", serialNumber: "1", sha256: "x", sha1: "y")
        ])
